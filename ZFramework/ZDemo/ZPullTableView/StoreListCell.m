...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UIImageView *addressImageView = [[UIImageView alloc] initWithFrame:CGRectMake(8, _nameLabel.bottom + 3, 12, 15)];
        addressImageView.image = [UIImage imageNamed:@"address_img.png"];
        [self.contentView addSubview:addressImageView];
        
        _addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(23, _nameLabel.bottom, 274*widthScale, 21)];
