...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *introTitleLabel = [ZHelper labelWithFrame:CGRectMake(8, 8, 60, 21)
                                                     fontSize:15
                                                        color:kMainColor
                                                textAlignment:0];
        ...
        _introLabel = [ZHelper labelWithFrame:CGRectMake(8, 30, kMainBoundsWidth - 16, 0)
                                        fontSize:13
        ...
        _awardTitileLabel = [ZHelper labelWithFrame:CGRectMake(8, 0, 43, 21)
                                              fontSize:14
                                                 color:kMainColor
                                         textAlignment:0];
        ...
        _awardLabel = [ZHelper labelWithFrame:CGRectMake(53, 0, kMainBoundsWidth-53-8, 0)
                                        fontSize:13
                                           color:[UIColor blackColor]
                                   textAlignment:0];
...
- (void)setModel:(BarberModel *)model
{
    ...
    if (model.award.length > 0) {
        ...
        [self.contentView addSubview:[ZHelper seperateCellWithY:_awardLabel.bottom + 8]];
    }else{
        _lineView.hidden = YES;
        _awardLabel.hidden = YES;
        _awardTitileLabel.hidden = YES;
        [self.contentView addSubview:[ZHelper seperateCellWithY:_introLabel.bottom + 8]];
    }
}
@end
