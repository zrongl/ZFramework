...
typedef enum {
     ...
     */
    objc_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    objc_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    objc_propertyMemoryManagementPolicyCopy
} objc_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #objc_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    objc_propertyMemoryManagementPolicy memoryManagementPolicy;
